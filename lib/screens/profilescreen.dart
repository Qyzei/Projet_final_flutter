      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            SizedBox(height: 10),
            buildAccountOption(context, "Change Passsword"),
            ...
            Row(
              children: [
                Icon(Icons.volume_up_outlined, color: Colors.purple),
                SizedBox(width: 10),
                Text("Notifications",
                    style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold))
              ],
            ...
            buildNotificationOption(
                "Account Active", valNotify2, onChangeFuction2),
            buildNotificationOption(
                "Opportunity", valNotify3, onChangeFuction3),
            SizedBox(height: 50),
            Center(
